...
public class GraficarSubrubro extends JFrame {
	...
	PostgreSQL.GraficaSubrubro graficaSubrubro=new GraficaSubrubro();
	...
	public GraficarSubrubro() {
		...
		contentPane.add(panel, BorderLayout.CENTER);
		 ...
		 getContentPane().add(panel);
	        ...
	        // Creando el Grafico
	        JFreeChart chart = ChartFactory.createPieChart3D("Grafica Subrubros",data, true, true, false);
	        ...
	        btnGraficar.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		...
	        		graficaSubrubro.setFechaFinal(fechaFinal);
	        		graficaSubrubro.setFechaInicial(fechaInicial);
	        		 
	        		 
	        		 
	        		graficaSubrubro.RecaudarDatos(conexion.conectar());
	       	      ...
	       	      while(iterador<graficaSubrubro.listaSubrubros.size()){
	       	    	
	       	    	rubro=graficaSubrubro.listaSubrubros.get(iterador).toString();
	       	    	cantidad=Float.parseFloat(graficaSubrubro.listaCantidad.get(iterador).toString());
	       	   ...
	       	   graficaSubrubro.listaCantidad.clear();
	       	   graficaSubrubro.listaSubrubros.clear();
	       	      fechaFinal="";
	       	      fechaInicial="";
